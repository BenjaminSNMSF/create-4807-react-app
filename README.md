...
Fork de CRA pour faciliter l'intégration de React dans 4807 :

- Pour faire fonctionner les chemins relatif, on doit connaitre le dossier où sera déployer le javascript.
  Il nous est fournis par la config `publicUrl` dans le fichier `ci-config.json`.
- Pour bundler sous forme d'une libraire `reactApp`

## Usage

- Nouveau projet : `npx create-react-app [nom] --scripts-version react-scripts-esf`
- Projet existant : `npm uninstall react-scripts` puis `npm install react-scripts-esf`
